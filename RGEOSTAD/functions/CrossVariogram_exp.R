CrossVariogram_exp<-function (CoorX, CoorY, P1, P2, NInt, lags, Direccion, Tol, Modelo, 
          ...
          NomP1, NomP2, NomP1P2) 
{
  ...
  legend(0.7 * MaxX1, 0.5 * MaxY1, c("Variance"), col = c("Red"), lty = c(1), lwd = 2, bty = "n")
  ...
  abline(h = var(P2), lty = 1, col = "Red", lwd = 2)
  #abline(v = Alcance, lty = 5, col = "green", lwd = 2)
  legend(0.7 * MaxX3, 0.5 * MaxY3, c("Variance"), col = c("Red"), lty = c(1), lwd = 2, bty = "n")
